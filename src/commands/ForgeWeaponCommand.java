...
public class ForgeWeaponCommand implements Command {
	public CopperIngot copperIngot;
	public IronIngot ironIngot;
	public GoldIngot goldIngot;
	public IBlacksmith blacksmith;
	
	public ForgeWeaponCommand(IBlacksmith blacksmith) {
		this.blacksmith = blacksmith;
	}
	
	public ForgeWeaponCommand(CopperIngot copper, IronIngot iron, GoldIngot gold, IBlacksmith blacksmith) {
	...
	public void execute() {
		...
		blacksmith.refineIron();
		blacksmith.forgeArmor("Great Weapon");
	}
